        ...
        <div className="mx-auto h-screen bg-orange-50 flex flex-col">
            ...
            <div className="flex-grow px-6">
                <form className="space-y-2" onSubmit={handleSubmit}>
                    <div>
                        <label className="block text-sm font-medium text-gray-500 mb-1 ml-1">送金上限額</label>
                        <div className="w-full p-4 text-gray-900 text-2xl font-bold">
                            {TRANSFER_LIMIT?.toLocaleString()}<span className="text-base ml-2">円</span>
                        </div>
                    </div>

                    <div>
                        <label className="block text-sm font-medium text-gray-500 mb-1 ml-1">送金額</label>
