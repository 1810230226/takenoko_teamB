...
# 履歴の初期データ
send_histories = [
    (1, "0123456", "1234567", "2025-08-27 20:10:25", 3000, "飲み代"),
    ...
    (5, "0123456", "2345678", "2025-09-03 22:35:50", 20000, "旅費")
]

# リンクの初期データ
links = [
    (1, "0123456", "1234567", "2025-08-22 16:15:25", 500, "お昼代", "After"),
    (2, "1234567", "0123456", "2025-09-03 09:30:12", 1000, "ガソリン代", "After"),
    (3, "0123456", "1234567", "2025-09-04 10:50:20", 10000, "宿代", "After")
    (4, "1234567", "0123456", "2025-09-05 07:12:30", 210, "電車賃", "Before")
]
